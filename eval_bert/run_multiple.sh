...
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy unc
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy unc --random
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy unc_density
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy isli
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy isli_density
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy isls
python run_bert.py  --dataset reuters --steps 100 --encoding elmo --save_repeat 5 --query_strategy isls_density
