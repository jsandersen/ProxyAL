...
save_dir = './imdb_sbert_rnd'
train_X_dir = './../encodings/imdb_sbert_%s_X_train.npy'
train_y_dir = './../encodings/imdb_sbert_%s_y_train.npy'
test_X_dir = './../encodings/imdb_sbert_%s_X_test.npy'
test_y_dir = './../encodings/imdb_sbert_%s_y_test.npy'
