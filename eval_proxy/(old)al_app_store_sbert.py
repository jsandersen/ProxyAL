...
if __name__ == "__main__":
    ...
    for i in range(n):
        ...
        al = SKLearnActiveLearner(10, getXtrain(), getytrain(), X_test, y_test, train_idx, LogisticRegression, {'random_state':0}, QueryStrategy.UNCERTAINTY)
